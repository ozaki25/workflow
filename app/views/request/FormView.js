...
module.exports = Backbone.Marionette.View.extend({
    ...
    ui: {
        ...
        openModalBtn: '.open-authorizer-modal',
        saveBtn     : '.save-btn',
    ...
    renderWorkDate: function() {
        this.getRegion('workDateRegion').show(new WorkDateTermView());
    },
    ...
    onClickSave   : function() { this.setRequest(this.model.getStatusAfterSave(), '保存', false); },
    onClickSubmit : function() { this.setRequest(this.model.getStatusAfterProgress(), '申請', true); },
    onClickApprove: function() { this.saveRequest(this.model.getStatusAfterProgress(), '承認'); },
    onClickAccept : function() { this.setWork(this.model.getStatusAfterProgress(), '受付', false); },
    onClickReport : function() { this.setWork(this.model.getStatusAfterProgress(), '作業完了報告', true); },
    onClickFinish : function() { this.saveRequest(this.model.getStatusAfterProgress(), '作業完了承認'); },
    onClickReject : function() { this.saveRequest(this.model.getStatusAfterRejection(), '否認'); },
    ...
    setRequest: function(nextStatusCode, action, validate) {
    ...
    setWork: function(nextStatusCode, action, validate) {
